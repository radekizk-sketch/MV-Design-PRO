...
export const STATION_WIZARD_STEPS: readonly StationWizardStepDefinition[] = [
  ...
  { id: 'ct',         n: 5,  label: 'Przekładniki prądowe', sub: '3-rdzeniowy + bilans + ALF',       group: 'Pomiary',    icon: '◎'  },
  { id: 'vt',         n: 6,  label: 'Przekładniki napięciowe', sub: '4-uzwojeniowy + bilans + ΔU',      group: 'Pomiary',    icon: '◌'  },
