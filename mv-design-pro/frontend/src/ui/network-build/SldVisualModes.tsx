...
export function SldVisualModes({ className }: SldVisualModesProps) {
  ...
  return (
    <div
      className={clsx(
        'flex items-center gap-0.5 rounded-md border border-gray-200 bg-gray-50 p-0.5',
        className,
      )}
    ...
    >
      ...
      <button
        ...
        className={clsx(
          'flex items-center gap-1.5 rounded px-2 py-1 text-[11px] transition-colors',
          skeletonView ? 'bg-slate-600 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100',
        )}
      ...
      {(isFilterActive || skeletonView) && (
        <div className="ml-1 flex items-center gap-1 rounded border border-amber-200 bg-amber-50 px-1.5 py-0.5 text-[10px] text-amber-700">
