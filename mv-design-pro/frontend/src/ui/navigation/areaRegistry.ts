...
export const AREA_DEFINITIONS: readonly AreaDefinition[] = [
  ...
  },
  {
    ...
    labelShort: 'Studia',
    description: 'Przypadki obliczeniowe, warianty pracy i uruchomienia analiz',
    icon: 'ikona-obszar-studia-obliczeniowe',
    shortcut: 'Ctrl+3',
    order: 3,
    available: true,
    statusType: 'missing-data',
    tooltip: 'Studia obliczeniowe - przypadki, warianty i uruchomienia analiz. Skrót: Ctrl+3.',
  ...
  },
  {
    ...
    labelShort: 'Raporty',
    description: 'Raporty OSD, uzasadnienia inżynierskie i paczki audytowe',
    icon: 'ikona-obszar-raporty-uzasadnienia',
    shortcut: 'Ctrl+8',
    order: 8,
    available: true,
    statusType: 'audit',
    tooltip: 'Raporty i uzasadnienia - raporty OSD, audyt i proof-pack. Skrót: Ctrl+8.',
  ...
  },
  {
    ...
    labelShort: 'Historia',
    description: 'Migawki modelu, uruchomienia obliczeń, zmiany i ślad audytu',
    icon: 'ikona-obszar-historia-audyt',
    shortcut: 'Ctrl+9',
    order: 9,
    available: true,
    statusType: 'audit',
    tooltip: 'Historia i audyt - migawki, uruchomienia, zmiany i ślad audytu. Skrót: Ctrl+9.',
