...
export const ROUTES = {
  ...
  VARIANTS: {
    hash: '#variants',
    label: 'Zakres i warunki obliczeń',
    description: 'Zarządzanie zakresem i warunkami obliczeń',
    icon: 'ZAK',
    requiredMode: 'MODEL_EDIT',
  },
  SWITCHGEAR: {
    hash: '#switchgear',
    label: 'Konfiguracja rozdzielnicy SN',
    description: 'Konfiguracja pól i aparatury rozdzielnicy SN',
    icon: 'SWG',
    requiredMode: 'MODEL_EDIT',
  },
  CASE_CONFIG: {
    ...
    description: 'Ustawienia warunków i zakresu obliczeń',
    icon: 'WRN',
    requiredMode: 'MODEL_EDIT',
  },
  ENM_INSPECTOR: {
