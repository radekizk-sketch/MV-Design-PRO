...
const SCREEN_DEFINITIONS: Record<WorkspaceScreenCode, WorkspaceSurfaceDefinition> = {
  ...
  'E-04': { screenCode: 'E-04', titlePl: 'Gotowość modelu i lista braków', componentRef: 'ModelGapsSurface', sizeClass: 'B', surfaceKind: 'analityczny', subjectKind: 'analysis_case', supportsMiniSld: false, supportsChildren: false, requiresSession: true },
  ...
  'E-06': { screenCode: 'E-06', titlePl: 'Wybór rodziny odcinka SN', componentRef: 'SegmentFamilyChooserSurface', sizeClass: 'A', surfaceKind: 'edycyjny', subjectKind: 'entity', supportsMiniSld: false, supportsChildren: true, requiresSession: true },
  ...
  'E-08': { screenCode: 'E-08', titlePl: 'Warianty pracy i przełączenia', componentRef: 'VariantSwitchingSurface', sizeClass: 'B', surfaceKind: 'analityczny', subjectKind: 'analysis_case', supportsMiniSld: true, supportsChildren: false, requiresSession: true },
  ...
  'E-10': { screenCode: 'E-10', titlePl: 'Źródło zasilania GPZ', componentRef: 'GpzSupplySourceSurface', sizeClass: 'B', surfaceKind: 'edycyjny', subjectKind: 'entity', supportsMiniSld: false, supportsChildren: true, requiresSession: true },
  'E-11': { screenCode: 'E-11', titlePl: 'Nowy odcinek ciągu głównego', componentRef: 'MainTrunkSegmentSurface', sizeClass: 'A', surfaceKind: 'edycyjny', subjectKind: 'entity', supportsMiniSld: false, supportsChildren: true, requiresSession: true },
  ...
  'E-14': { screenCode: 'E-14', titlePl: 'Pole SN - aparatura, przekładniki i zabezpieczenia', componentRef: 'FieldWorkspaceSurface', sizeClass: 'C', surfaceKind: 'edycyjny', subjectKind: 'entity', supportsMiniSld: true, supportsChildren: true, requiresSession: true },
  ...
  'E-17': { screenCode: 'E-17', titlePl: 'Źródło fotowoltaiczne', componentRef: 'PvSourceSurface', sizeClass: 'B', surfaceKind: 'edycyjny', subjectKind: 'entity', supportsMiniSld: false, supportsChildren: true, requiresSession: true },
  ...
  'E-22': { screenCode: 'E-22', titlePl: 'Domknięcie pierścienia i punkt normalnie otwarty', componentRef: 'RingNopSurface', sizeClass: 'B', surfaceKind: 'edycyjny', subjectKind: 'entity', supportsMiniSld: false, supportsChildren: true, requiresSession: true },
  'E-23': { screenCode: 'E-23', titlePl: 'Obciążenie nN', componentRef: 'NnLoadSurface', sizeClass: 'B', surfaceKind: 'edycyjny', subjectKind: 'entity', supportsMiniSld: false, supportsChildren: false, requiresSession: true },
  'E-24': { screenCode: 'E-24', titlePl: 'Poziom analityczny i wyniki inżynierskie', componentRef: 'AnalysisWorkspaceSurface', sizeClass: 'C', surfaceKind: 'analityczny', subjectKind: 'analysis_run', supportsMiniSld: true, supportsChildren: true, requiresSession: true },
  'E-25': { screenCode: 'E-25', titlePl: 'Potwierdzenie usunięcia i skutki topologiczne', componentRef: 'DestructiveTransactionSurface', sizeClass: 'B', surfaceKind: 'edycyjny', subjectKind: 'entity', supportsMiniSld: false, supportsChildren: false, requiresSession: true },
  ...
  'E-28': { screenCode: 'E-28', titlePl: 'Koordynacja zabezpieczeń', componentRef: 'ProtectionCoordinationSurface', sizeClass: 'C', surfaceKind: 'analityczny', subjectKind: 'analysis_run', supportsMiniSld: true, supportsChildren: false, requiresSession: true },
  'E-29': { screenCode: 'E-29', titlePl: 'Składowe symetryczne i sieć zerowa', componentRef: 'SymmetricalComponentsSurface', sizeClass: 'C', surfaceKind: 'analityczny', subjectKind: 'analysis_run', supportsMiniSld: true, supportsChildren: false, requiresSession: true },
  'E-30': { screenCode: 'E-30', titlePl: 'Wymagania przyłączeniowe i kodeks sieciowy', componentRef: 'ComplianceSurface', sizeClass: 'C', surfaceKind: 'analityczny', subjectKind: 'analysis_run', supportsMiniSld: true, supportsChildren: false, requiresSession: true },
  'E-31': { screenCode: 'E-31', titlePl: 'Rejestr założeń i jakości danych', componentRef: 'AssumptionsQualitySurface', sizeClass: 'B', surfaceKind: 'analityczny', subjectKind: 'analysis_case', supportsMiniSld: false, supportsChildren: false, requiresSession: true },
  'E-32': { screenCode: 'E-32', titlePl: 'Wkłady źródeł', componentRef: 'SourceContributionsSurface', sizeClass: 'C', surfaceKind: 'analityczny', subjectKind: 'analysis_run', supportsMiniSld: true, supportsChildren: false, requiresSession: true },
  'E-33': { screenCode: 'E-33', titlePl: 'Weryfikacja cieplna i dynamiczna toru prądowego', componentRef: 'ThermalDynamicSurface', sizeClass: 'C', surfaceKind: 'analityczny', subjectKind: 'analysis_run', supportsMiniSld: true, supportsChildren: false, requiresSession: true },
  'E-34': { screenCode: 'E-34', titlePl: 'Zbieżność rozpływu mocy i regulacja zaczepów', componentRef: 'ConvergenceOltcSurface', sizeClass: 'B', surfaceKind: 'analityczny', subjectKind: 'analysis_run', supportsMiniSld: true, supportsChildren: false, requiresSession: true },
};
...
export const ISSUE_MATRIX: Record<string, CanonicalIssuePolicy> = {
  ...
  'analysis.not_applicable': {
    severity: 'info',
    scope: 'analysis_case',
    defaultMessagePl: 'Moduł nie dotyczy bieżącego zakresu obliczeń.',
    repairTarget: null,
    blocksSave: false,
    blocksAnalysis: false,
    blocksReport: false,
