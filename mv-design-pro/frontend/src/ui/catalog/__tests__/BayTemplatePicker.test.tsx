...
function makeTemplate(
  ...
  return {
    ...
    // Kompozycja aparatów pola — pole WYMAGANE kontraktu
    // (`base_template.devices`); fikstura odwzorowuje układ kanoniczny pola
    // liniowego wyjściowego z `catalog/bay_templates.py`.
    base_template: {
