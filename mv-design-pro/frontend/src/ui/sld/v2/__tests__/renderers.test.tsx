/**
 * PR-5b — Testy rendererów v2 (żywych, importowanych przez v3/powierzchnie).
 * F12-C (spec §10.1 ARCH-4): sekcje SldCanvasV2-smoke i CableRunRenderer
 * USUNIĘTE razem ze skasowaną ścieżką renderu v2 (oba komponenty martwe —
 * jedynym importerem był SldCanvasV2).
 *
 * Inwarianty:
