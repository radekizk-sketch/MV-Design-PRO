...
describe('SCHEMAT-10 S7.6 — kontraktowe minimum światła pasm (Z1 KOMPRESJA)', () => {
  ...
  it('kompresja obniżyła piony vs korytarz-etykiety (fixtura referencyjna, wszystkie LOD)', () => {
    ...
    // ETYKIETY §7 (2026-07-23) PODNIESIONY do 22944/39888/39888 (+960/LOD) —
    ...
    // LV DOMAIN PROJECTION (po B-02, 2026-09-01): 21064/37272/37272 →
    // 22672/45656/45656 — portal domeny nN na zacisku KAŻDEJ stacji z TR +
