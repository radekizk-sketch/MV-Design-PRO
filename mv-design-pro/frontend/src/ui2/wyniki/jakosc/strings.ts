...
export const JAKOSC_STRINGS = {
  ...
  sciezkaObliczeniowa: 'Ścieżka obliczeniowa',
  // Karta F-K1 faza 6 (Calculation Evidence) — uwagi właściciela 1, 2, 9, 10, 13, 15.
  kolPowodDecyzji: 'Powód decyzji',
  kolEnergiaCieplna: 'Energia I²·t',
  kolEnergiaCieplnaDop: 'Dopuszczalna k²·S²',
  kolWykorzystanieCieplne: 'Wykorzystanie',
  ikonaSpelnione: '✔',
  ikonaNaruszone: '✖',
  ikonaNiesprawdzone: '—',
  sekcjaKryteria: 'Kryteria cząstkowe',
  sekcjaKryteriaOpis:
    'Ten sam warunek zapisany prądowo, energetycznie i przekrojowo — trzy zapisy muszą dać ten sam werdykt.',
  sekcjaZalecenia: 'Co doprowadzi gałąź do zgodności',
  sekcjaZaleceniaOpis:
    'Każde działanie wynika z przekształcenia tej samej nierówności I²·t ≤ k²·S² względem jednej zmiennej.',
  sekcjaWrazliwosc: 'Wrażliwość wyniku',
  ...
  kolumnaWykorzystanie: 'Wykorzystanie',
  kolumnaDzialanie: 'Działanie',
  kolumnaObecnie: 'Obecnie',
  kolumnaDocelowo: 'Docelowo',
  kolumnaSkutek: 'Skutek',
  brakUzasadnieniaK: 'Niepełne uzasadnienie k — brak: ',
