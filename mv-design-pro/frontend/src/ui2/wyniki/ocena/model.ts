...
/** Etykieta PL domeny fizycznej — WYŁĄCZNIE z backendu (`physics_domain_pl`); `null` = kreska. */
export function domenaFizycznaPL(etykieta: string | null): string {
  return etykieta ?? T.marginesBrak;
}
