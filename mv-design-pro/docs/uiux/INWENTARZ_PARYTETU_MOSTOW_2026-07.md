...
| L-16 | Katalogi CT, VT, kable nN, aparaty nN | `spaces/model/katalog` | ZAMKNIĘTA (KD-3, V12K-292, 2026-07-31): cztery kategorie dopisane do `KATEGORIE` adaptera ui2 z 20 definicjami parametrów (z normami i mapowaniem na realne końcówki katalogu) |
