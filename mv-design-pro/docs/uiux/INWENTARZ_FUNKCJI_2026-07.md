...
| Katalog typów | — | catalog (46 końcówek — pomiar 2026-08-14; w tym `GET /api/catalog/switchgear-families` i subzasób `factory-configurations`: 18 rodzin rozdzielnic SN/RMU, 95 konfiguracji fabrycznych, walidator `family_supports`), audit2_catalogs | `ui2/spaces/model/katalog` (KatalogPanel, KartaTechniczna, GdzieUzyty, ParametrRow); 7 testów; rodziny+bloki konsumowane przez krok 4 kreatora stacji (tory MODULARNY/BLOK_RMU) | ✅ |
