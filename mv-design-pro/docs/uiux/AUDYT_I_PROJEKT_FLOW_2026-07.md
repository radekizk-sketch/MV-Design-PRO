...
| **F-K4** faza 3 | Stabilność RMS i koordynacja zabezpieczeń: kontrakty nie niosą TYPU elementu (stabilność) ani werdyktu miskoordynacji z identyfikatorem urządzenia (koordynacja) — domknięcie wymaga addytywnego rozszerzenia kontraktu backendu | **Z4** (reszta) |
