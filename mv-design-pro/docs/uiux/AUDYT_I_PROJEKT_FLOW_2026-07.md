...
| **F-K4** | Pętla decyzji na pozostałych ekranach wyników (9 ekranów) — po F-K3 wzorzec mapowania „kryterium → element modelu” jest gotowy (`werdykt/werdyktModel.ts`) | **Z4** |
