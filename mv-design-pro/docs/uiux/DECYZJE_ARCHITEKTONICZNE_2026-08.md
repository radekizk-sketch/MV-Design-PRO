...
**D1 — NAWIGACJA: kanon = 7 przestrzeni ui2 (W-110).** Mapowanie 9 obszarów
...
**D2 — SHELL V3: USUNIĘTY.** Flaga `USE_LAYOUT_V3` i jej martwa gałąź znikają
...
**D4 — PALETA KOMEND: jedna (`ui2/search`).** Komendy unikalne z
