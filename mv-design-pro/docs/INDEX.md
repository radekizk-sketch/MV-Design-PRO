...
### Audyty
- [audit/INWENTARZ_WERDYKTOW_LAKONICZNYCH_2026-09-23.md](./audit/INWENTARZ_WERDYKTOW_LAKONICZNYCH_2026-09-23.md) — inwentarz powierzchni z lakonicznym werdyktem (pięć przeglądów Opus 5.5, 283 wiersze `plik:linia`: 181 MIGRACJA · 54 ENUM_WEWNETRZNY · 48 LEGACY_USUNAC; zapadka strażnika `werdykt_wyjasnialny_guard`; wzorce klasy: limit bez źródła, brak danych → werdykt, puste PASS, werdykt liczony w UI, dane wyjaśniające nierenderowane, sześć reguł dla jednej wielkości)
- [audit/ab-raw/MACIERZ_LUK_DYNAMIKI_OPUS_2026-09-23.md](./audit/ab-raw/MACIERZ_LUK_DYNAMIKI_OPUS_2026-09-23.md) — [RAW, niewiążący] macierz luk dynamiki RMS (przegląd Opus 5.5, 28 pozycji ze stanem `plik:linia`, sondy P1–P3, sprzeczności, ryzyka fałszywego werdyktu, korekty sekwencji AB)
- [audit/ab-raw/AUDYT_HARMONICZNE_SUPRAHARMONICZNE_OPUS_2026-09-23.md](./audit/ab-raw/AUDYT_HARMONICZNE_SUPRAHARMONICZNE_OPUS_2026-09-23.md) — [RAW, niewiążący] audyt harmonicznych i supraharmonicznych (Opus 5.5: inwentarz, sondy P1–P14 — THD 3049 % w scenie demonstracyjnej, brak przekładni, sieć 1e6 S; klasyfikacja ADOPT/ADAPT/REWRITE/REJECT; macierze luk harmonicznych, supraharmonicznych, multi-physics, regulacyjnych, modeli, wyroczni, pomiarów, CI)
...
- [plan/PLAN_AB_DYNAMIKA_A_B_2026-09.md](./plan/PLAN_AB_DYNAMIKA_A_B_2026-09.md) — **program A/B** (wiążący, 2026-09-22/23): dynamika RMS, jakość energii (harmoniczne, supraharmoniczne, multi-physics) i zgodność modułów wytwarzania typu A i B w nN/SN nad jednym ENM; rejestr decyzji O-1…O-20 (delegacja właściciela, poprawka „zakaz lakonicznych werdyktów", mandat kontynuacji), architektura wielofizyczna, sekwencja AB-1a → AB-1b → AB-1d_min → AB-1c → AB-2…AB-7 z kartami AB-H0…AB-H4 jako zależnościami, karta AB-1a, macierze luk (uzupełniane z przeglądów Opus 5.5), inwentarz powierzchni werdyktów, scenariusze E2E R/H/SH/MP, standard dowodu per domena; powierzchnia pamięci programu
- [plan/KARTA_AB_1A_WERDYKT_I_PROFIL_2026-09.md](./plan/KARTA_AB_1A_WERDYKT_I_PROFIL_2026-09.md) — karta wykonawcza AB-1a (2026-09-23): rozstrzygnięcia §0 (pakiet `werdykt/`, jeden typ podstawy, walidacja przy konstrukcji, WiPWC, Bank Nastaw, klasa tylko z backendu, OD-26, strażnik), inwentarz klasy, pakiety pracy A–E z bramkami, granice, definicja ukończenia
...
- [domain/KONTRAKT_WERDYKTU_WYJASNIALNEGO.md](./domain/KONTRAKT_WERDYKTU_WYJASNIALNEGO.md) — **kontrakt werdyktu wyjaśnialnego** (wiążący, przekrojowy, 2026-09-22): status maszynowy nigdy nie jest samodzielnym wynikiem; `OcenaKryterium` / `WynikWymagania` z obowiązkowym `WyjasnienieWerdyktu` (przedmiot · kryterium · wynik z jednostką · limit z podstawą i stanem źródła · margines · niepewność · przyczyna · dowód · status modelu i danych · zakres ważności · ślad), słownik statusów i reguły decyzji/agregacji, oś kompletności dowodu, etykiety UI, blok dokumentu formalnego, testy T1–T13, strażnik kontraktowy
