...
| G07 | BESS ładowanie / rozładowanie | PARTIAL | ENM | REGRESSION_ONLY | — | `application.reference_networks.enm_builders.oze_pv_bess:build_oze_pv_bess_enm` | solver |
...
| B-BENCH | benchmarki opublikowane IEEE / CIGRE / IEC 60909 / pandapower | SUPPORTED | ENM | INDEPENDENTLY_VERIFIED, PUBLISHED_BENCHMARK, NORMATIVE | LF, SC | `application.reference_networks.enm_builders.ieee_4bus:build_ieee_4bus_enm`<br>`application.reference_networks.enm_builders.ieee_9bus:build_ieee_9bus_enm`<br>`application.reference_networks.enm_builders.ieee_13bus:build_ieee_13bus_enm`<br>`application.reference_networks.enm_builders.ieee_14bus:build_ieee_14bus_enm`<br>`application.reference_networks.enm_builders.ieee_34bus:build_ieee_34bus_enm`<br>`application.reference_networks.enm_builders.ieee_39bus:build_ieee_39bus_enm`<br>`application.reference_networks.enm_builders.cigre_mv:build_cigre_mv_enm`<br>`application.reference_networks.enm_builders.cigre_lv_benchmark:build_cigre_lv_benchmark_enm`<br>`application.reference_networks.enm_builders.pp_simple_four_bus:build_pp_simple_four_bus_enm`<br>`application.reference_networks.enm_builders.iec60909_example:build_iec60909_example_enm`<br>`application.reference_networks.enm_builders.pandapower_iec60909_radial:build_pandapower_iec60909_radial_enm` | solver_output_drift_guard, reference_networks_validation_guard |
