...
| `docs/audit/` vs `docs/audits/` (historyczny duplikat) | Wcześniej dwa katalogi (24 plików vs 9 plików) | Mylą się ścieżki | P1 ✅ | **ROZWIĄZANE 2026-05-13** — wszystkie audyty skonsolidowane w `docs/audit/`, `docs/audits/` usunięty. |
