> **ARCHIWUM DOWODOWE — nie kanon.** Zrodlo: `origin/claude/max-dynamic-audit-kzbivg` @ `85084102` (sciezka na tej galezi: `mv-design-pro/docs/plan/KARTA_MAX_DYNAMIC_SIMULATION_AUDIT_2026-09.md`). Klasyfikacja: `docs/plan/SYNTEZA_DOMKNIECIA_PRODUKTU_2026-09.md` §3 (audyt wielosoczewkowy watku badawczego dynamiki (karty D01-D13, ryzyko postaci modelu)). Skopiowane przez karte W6-1 (`docs/plan/KARTA_W6_1_KONTRAKTY_CZASU_2026-09.md` SS0 p.9) jako dowod historyczny watku badawczego — TRESC PONIZEJ jest zamrozona kopia zrodlowego pliku (bez zadnej redakcji tresci wlasciwej), NIE jest zywym planem ani obowiazujacym zrodlem prawdy. Kanon zastepujacy ten watek: `docs/plan/SYNTEZA_DOMKNIECIA_PRODUKTU_2026-09.md` i karty W6-0..W6-8.
