> **DEPRECATED — ZARCHIWIZOWANE 2026-09-16** (synteza domknięcia produktu, karta S-5, A-11).
> To jest migawka rejestru stanu `STAN_REPO.md` z 2026-05-29 (gałąź `claude/zealous-bardeen-xrqtp`,
> domknięcie V12.6). Zawierała deklaracje sprzeczne z kodem (m.in. „Stabilność dynamiczna RMS — PODPIĘTE"
> przy 0 konsumentach `stability_rms` poza własnym pakietem; liczniki testów z maja 2026). Zastąpiona
> przez nowy `STAN_REPO.md` (tabela stanu z pomiaru + odesłania), `docs/plan/MAPA_DOMKNIECIA_PRODUKTU_2026-09.md`,
> `docs/evidence/CONVERGENCE_EVIDENCE.md` i `docs/plan/SYNTEZA_DOMKNIECIA_PRODUKTU_2026-09.md`.
> Zachowana wyłącznie jako dowód historyczny; nie cytować jako stanu.
