...
| `GET /api/analysis-runs/{run_id}/pakiet-dowodowy` | v12xx | aktywny | 2026-08-07 | - | Pakiet dowodowy przebiegu (ZIP: dowod, zrodlo LaTeX, wykaz plikow, odcisk); rodzaj pakietu z danych biegu. Rodzaje punktowe (zwarcia) przyjmuja parametr `punkt`; pakiet rozplywu mocy opisuje CALA siec i `punkt` odrzuca (422). | pakiet dowodowy biegu API tests | Architekt dowodow |
| `GET /api/analysis-runs/{run_id}/pakiet-dowodowy/dostepnosc` | v12xx | aktywny | 2026-08-07 | - | Dostepnosc pakietu dowodowego przebiegu: rodzaj, punkty zwarcia (puste dla rodzaju opisujacego cala siec), opis zawartosci, powod braku PL. | pakiet dowodowy biegu API tests | Architekt dowodow |
