...
Sekwencja bazowa (mandat kontynuacji §4, skorygowana po ETAP 4–8; O-20, O-35): **AB-1a → AB-1b.1 →
AB-1b.2 → AB-1b.3 → AB-1d_min → AB-1c → AB-1d → AB-H1 → AB-2 → AB-3 → AB-3b → AB-3c → AB-4a → AB-H2 →
W6-K → AB-4b → AB-5 → AB-5b → AB-H3 → AB-6 → AB-H4 → AB-7** (W6-K po W5 — zadanie #23; AB-H0 wewnątrz
AB-1). Ten wiersz jest kolejnością WIĄŻĄCĄ (strażnik `plan_ab_zaleznosci_guard` sprawdza go wobec
