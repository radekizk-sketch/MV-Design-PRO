...
`fable-w3f2`, uzgodnienie `32d01cf8`):** W3-F — skalowanie jednostek w jednym miejscu (`pochodne/jednostki.py`, 20 funkcji),
...
przy odbiorze (agenci nie pisali do współdzielonego rejestru); (6) W3-G1–G3 i W3-H (fala 3) oraz karta TRACE-V2 — w toku.
