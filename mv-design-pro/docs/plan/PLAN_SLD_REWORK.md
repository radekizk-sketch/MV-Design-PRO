...
**Data:** 2026-08-05 (sync-doc — status faz S5/S7/S8 zweryfikowany wobec docs/v12xx/REJESTR_KONFLIKTOW.md)
**Wersja:** 1.0
**Powiązane:**
...
| S5 Goldeny + dowód | wymiana goldenów jednym commitem; sekwencja zoom ≥3 kroki; macierz parytetu funkcji (overlaye, strzałki, znacznik, menu, edycja, kreatory, deep-linki) | S1–S4 | ✅ 2026-07-23 (karta S5-FINAL, V12K-142: dowód domknięcia programu SCHEMAT-10 — goldeny świeże [baseline'y wbudowane w sld_v3_acceptance.mjs, zero regeneracji, accept ALL PASS + regresja 3541], sekwencja zoom 6 kadrów s5-zoom-1..6 z kotwicą station-name identyczną L0/L1/L2, macierz parytetu 11/11 + grammarRule18 4/4; weryfikacja Fable po cherry-picku 0a66120d: vitest 182 plików/3541, 7 guardów 0. Program SCHEMAT-10 fazy S1–S8 + GS-1..GS-5 + P1 recenzji DOSTARCZONE) |
...
| S7 Layout P1 | globalne rozmieszczanie opisów — przemieszczanie zamiast tylko odrzucania (15); klastry podobnych gałęzi (6); optymalizacja wydruku A0/A1 (12, po S4) + PEŁNY silnik footprint-driven S7.1–S7.6 (compact comb, piony proporcjonalne, balancing, funkcja kosztu, migracja LayoutResult, rozdzielone światła) — WARUNKI_ODBIORU_S6 w całości | S6, S4 | ✅ 2026-07-23 (karta S7.6-KOMPRESJA, V12K-146: kompresja pionowa arkusza — etykieta zejścia przeniesiona z zawyżającego gapAbove do dedykowanego pasa zejść pod magistralą; wysokość bbox arkusza -24% (4457→3409), Σpionów L0 -22%, L1/L2 -14%, bboxUtilization +31%, inkDensity +22–25%, gapAbove pasm L1 -87%; niezmienniki (poziomy/crossings/kolizje/M-02/nieortogonalność/minClearance) BEZ ZMIAN; test kompresji (22) + fixtury H. Weryfikacja Fable po cherry-picku f0378e1d: type-check 0, lint 0, vitest 184 plików/3571, accept ALL PASS, 6 guardów 0. WARUNKI_ODBIORU_S6 spełnione) |
| S8 Płynność LOD P2 | płynne przejścia między L0/L1/L2 (13; kotwice STAŁE — rozstrzygnięcie w recenzji: adaptacyjny jest detal, nie layout) | S6 | ✅ 2026-07-23 (karta S8-LOD, V12K-141: progi LOD wyprowadzone z czytelności (l1Max=1,2 — brama etykiety t2 11px; l0Max=0,4 — brama glifu 48px) z martwymi strefami [0,85·t .. 1,15·t]; dowód anty-trzepotania liczbami (drganie w martwej strefie L1↔L2/L0↔L1 ⇒ 0 przełączeń, pełne przekroczenie ⇒ dokładnie 2); crossfade detalu natywnym SMIL (deterministyczny w eksporcie), ciągłość selekcji/overlay po ownerRef, viewport zachowany (JEDNA KOTWICA). Weryfikacja Fable po cherry-picku eb268a30: vitest 3537/181 plików, accept ALL PASS, 5 guardów 0, lod_path_probe topologia identyczna L0/L1/L2. Bez jawnych długów) |
