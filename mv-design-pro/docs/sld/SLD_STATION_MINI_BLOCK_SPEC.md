...
- `renderer/__tests__/miniBlockRmu.test.tsx` — 24 cases (kompozycja z bays, blocker badge, DER badges, viewBox invariant, footprintów derive).
- W połączeniu z `gpzCompactBlock.test.tsx` (21 cases) → 45 cases pokrywają mini-block + GPZ compact.
