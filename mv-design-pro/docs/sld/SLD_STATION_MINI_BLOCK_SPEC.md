...
- `renderer/__tests__/miniBlockRmu.test.tsx` - 38 cases (kompozycja z bays, blocker badge, DER badges, viewBox invariant, derive footprintów, K30-40 voltage-aware SN bus).
- W połączeniu z `gpzCompactBlock.test.tsx` (21 cases) → 59 cases pokrywają mini-block + GPZ compact.
