...
| DET-02 | Permutation invariance: permutuj wejscie → identyczny hash | Sortowanie po id istnieje, ale BRAK testu permutacji wejscia. | **ISTOTNA**: Brak testu permutation invariance. Krytyczne dla benchmark-grade. | **PR-3A-03** |
