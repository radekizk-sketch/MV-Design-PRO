...
> **POZOSTAJE w §3:** (a) bramka OSD — blokada ESTIMATED/SYSTEM_DEFAULT w pakiecie bez akceptacji inżyniera; (b) karty referencyjne per klasa (string PV/central/BESS PCS) z realnych datasheetów (pasma z literatury jako ESTIMATED); (c) testy egzekwowania. Potem **D-03 SSCI** na modelu pasma (pełny Nyquist Z_grid/Z_conv).
