...
def _sekcyjna(
    ...
    bays: int, feeders: int, use_case: str,
) -> StationTemplate:
    return StationTemplate(
        ...
        schema=TemplateSchema(
            ...
            sn_bays_count=TemplateParamInt(default=bays, min_value=2, max_value=8, label_pl="Liczba pól SN"),
            sn_bay_roles=(
            ...
            nn_feeders_count=TemplateParamInt(default=feeders, min_value=2, max_value=8, label_pl="Liczba odpływów nN"),
