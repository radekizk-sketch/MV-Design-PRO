    ...
    *,
    ...
    return StationTemplate(
        ...
        schema=TemplateSchema(
            ...
            # Stacja słupowa: „pole" jest tu zestawem aparatów na słupie
            # (odłącznik/rozłącznik bezpiecznikowy w odejściu do transformatora),
            # nie przedziałem rozdzielnicy wnętrzowej — ale rola w modelu jest
            # ta sama i ten sam aparat decyduje o odłączalności.
            sn_bay_roles=(
                BayRoleSpec(role="IN", label_pl="Pole liniowe IN"),
                BayRoleSpec(role="TR", label_pl="Odejście do transformatora"),
            ),
