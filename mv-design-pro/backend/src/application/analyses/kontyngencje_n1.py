...
2. BIEG PEŁNY ze ZNANYM kosztem: ta sama zapowiedź podaje przed startem, ile
   ...
   wyrażamy czasem — pomiar 0,472 s/kontyngencję pochodzi z substratu
   referencyjnego (INNEGO modelu), a przeliczenie go na bieżącą sieć byłoby
   liczbą zmyśloną (kontrakt nie niesie pomiaru czasu z tego modelu).
