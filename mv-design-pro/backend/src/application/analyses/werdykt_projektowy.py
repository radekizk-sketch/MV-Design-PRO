...
REJESTR_KRYTERIOW: tuple[DefinicjaKryterium, ...] = (
    DefinicjaKryterium(
        ...
        warunek_pl="abs(P) <= moc przylaczeniowa z warunkow OSD",
    ...
    DefinicjaKryterium(
        ...
        warunek_pl="cosfi >= cosfi wymagany w warunkach OSD",
        norma_pl="Warunki przylaczenia OSD (dokument projektu)",
        zrodlo=ZRODLO_PF,
        element_rodzaj=ELEMENT_SZYNA,
    ),
    DefinicjaKryterium(
        ...
        warunek_pl="abs(dU) <= dopuszczalne odchylenie napiecia",
    ...
    DefinicjaKryterium(
        ...
        warunek_pl="I_rob <= obciazalnosc dlugotrwala przewodu",
    ...
    DefinicjaKryterium(
        ...
        warunek_pl="S_rob <= moc znamionowa transformatora",
    ...
    DefinicjaKryterium(
        ...
        warunek_pl="straty <= zalozony budzet strat",
    ...
    DefinicjaKryterium(
        ...
        warunek_pl="Ik'' w pasmie wiarygodnosci dla poziomu napiecia",
