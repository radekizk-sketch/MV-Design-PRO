...
def admitancja_zwarcia_pu(
    ...
    Zwarcie metaliczne (`R_f = X_f = 0`) nie ma skonczonej admitancji i NIE
    przechodzi przez te funkcje: `zdarzenia.py::zbuduj_harmonogram` kieruje je do
    mechanizmu wiersza ograniczenia `V = 0` (karta AB-1b.1 par. 0 pkt 3; test
    `test_zwarcie_metaliczne_idzie_wierszem_ograniczenia_a_nie_admitancja`). Ten
    `raise` zostaje jako ostatnia bariera dla kazdej innej sciezki wywolania:
    „bardzo duza liczba" bylaby cicha fabrykacja.
    """
