...
_SOURCE = "Katalog kompensatorów MV-DESIGN-PRO / wartości referencyjne"
...
def get_all_shunt_capacitor_records() -> list[dict]:
    ...
    return [
        _record(
            ...
            name="Bateria kondensatorów SN 0,6 Mvar 15 kV",
            rated_mvar=0.6,
            rated_kv=15.0,
            loss_kw=0.3,
        ),
        _record(
            ...
            name="Bateria kondensatorów SN 1,2 Mvar 15 kV",
            rated_mvar=1.2,
            rated_kv=15.0,
            loss_kw=0.6,
        ),
        _record(
            ...
            name="Bateria kondensatorów SN 2,4 Mvar 15 kV",
            rated_mvar=2.4,
            rated_kv=15.0,
            loss_kw=1.2,
        ),
        _record(
            ...
            name="Bateria kondensatorów SN 1,8 Mvar 20 kV",
            rated_mvar=1.8,
            rated_kv=20.0,
            loss_kw=0.9,
        ),
        _record(
            ...
            name="Bateria kondensatorów SN 3,6 Mvar 20 kV",
            rated_mvar=3.6,
            rated_kv=20.0,
            loss_kw=1.8,
        ),
