...
# See: docs/sld/SLD_SEMANTIC_MODEL_CANONICAL_V1.md rule 6 + "Egzekucja reguly 6" (this
# module is cited there as the enforcing symbol, with the pinning test). Formerly
# SD-020/SD-021 in the retired checklist docs/audit/archive/CANONICAL_COMPLIANCE_2026-01.md
# -- kept there as historical context only.
...
def project_snapshot_to_sld(snapshot: NetworkSnapshot) -> SldDiagram:
    with snapshot_read_only_guard(snapshot, operation="project_snapshot_to_sld"):
        ...
        # BoundaryNode markers should be generated by the interpretation layer (BoundaryIdentifier).
