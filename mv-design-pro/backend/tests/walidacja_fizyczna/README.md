...
| bramka G14 (D-12) | zdarzenia warunkowe: chwila przekroczenia i chwila WYKONANIA akcji wobec postaci zamkniętej rampy (tolerancje 10⁻⁶ i 10⁻⁹ s, trapez i RK4) i wobec pierwiastka trajektorii dyskretnej trapezu członu inercyjnego — jako stosunek błędu do tolerancji (+ ulp); kierunek pobudzenia; zwłoka 0,3 s z kasowaniem i bez przy zapadzie 0,25 s |
