...
| `stanowisko.py` | Ten sam układ liczony **produktem**. Parametry podane jawnie po obu stronach — nic nie jest importowane z wyroczni do stanowiska ani odwrotnie. |
| `bramki.py` | Bramki fizyczne G1–G13 z progami **wyprowadzonymi**, nie dobranymi. Uzasadnienie każdego progu stoi przy nim. |
...
| G7 | częstotliwość węzłowa wobec **dokładnej** pochodnej analitycznej |
...
| G13 | wyspa z odbiorem i bez źródła kończy się odmową nazwaną |
